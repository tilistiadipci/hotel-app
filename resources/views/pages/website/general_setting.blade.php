                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-0">
                        <select name="default_language"
                            ...
                            <option value="en_US"
                                {{ old('default_language', $settings['default_language']) === 'en_US' ? 'selected' : '' }}>
                                {{ trans('common.settings_page.english_us') }}
                            </option>
                            <option value="id_ID"
                                {{ old('default_language', $settings['default_language']) === 'id_ID' ? 'selected' : '' }}>
        ...
        <div class="card mb-3">
            ...
            <form method="POST" action="{{ route('settings.update') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-0">
                        <label class="d-block">App Logo 1</label>
                    ...
                    <div class="form-group mt-4 mb-0">
                        <label class="d-block">App Logo 2</label>
                        <div class="d-flex align-items-center mb-2">
                            <button type="button" class="btn btn-outline-primary btn-sm mr-2" id="btnPickImage2">
                                <i class="fa fa-image mr-1"></i> {{ trans('common.pick_file') }}
                            </button>
                            <div class="text-muted small" id="selectedImageLabel2">
                                {{ trans('common.no_file_selected') }}
                            </div>
                        </div>
                        <input type="hidden" name="general_app_logo2" id="image_media_id2"
                            value="{{ old('general_app_logo2', $generalAppLogo2Id ?? '') }}">

                        @if (!empty($generalAppLogo2Url))
                            <div class="mt-2" id="currentCoverPreview2">
                                <small class="text-muted d-block">Current image:</small>
                                <img src="{{ $generalAppLogo2Url }}" class="img-thumbnail shadow-sm"
                                    style="max-height: 200px; object-fit: cover;" alt="App Logo 2">
                            </div>
                        @endif

                        <div class="mt-2 d-none" id="imagePreviewWrap2">
                            <small class="text-muted d-block">Preview:</small>
                            <img id="imagePreview2" class="img-thumbnail shadow-sm"
                                style="max-height: 200px; object-fit: cover;" alt="Preview">
                        </div>

                        @error('general_app_logo2')
                            <div class="text-danger small mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
    ...
    <div class="col-lg-6">
        <div class="card mb-3">
            <div class="card-header">
                ...
                {{ trans('common.settings_page.transaction_charge_settings') }}
            </div>
            <form method="POST" action="{{ route('settings.update') }}">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="border rounded p-3 mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="pr-3">
                                <h5 class="mb-1">
                                    {{ trans('common.settings_page.tax_percentage_grand_total_status') }}</h5>
                                <p class="mb-0 text-muted">
                                    {{ trans('common.settings_page.tax_percentage_grand_total_status_desc') }}</p>
                            </div>
                        ...
                        <div class="form-group mb-0">
                            <label
                                for="tax_percentage_grand_total">{{ trans('common.settings_page.tax_percentage_grand_total') }}</label>
                    ...
                    <div class="border rounded p-3">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="pr-3">
                                ...
                                <p class="mb-0 text-muted">
                                    {{ trans('common.settings_page.service_charge_status_desc') }}</p>
                            </div>
                        ...
                        <div class="form-group mb-0">
                            <label
                                for="service_charge_fixed">{{ trans('common.settings_page.service_charge_fixed') }}</label>
                            <input type="number" step="0.01" min="0"
