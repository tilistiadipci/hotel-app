...
@section('content')
    @php
        $isShoppingMenuActive = (bool) ($isShoppingMenuActive ?? true);
        $metricColClass = $isShoppingMenuActive ? 'col-md-6 col-xl-3' : 'col-md-6 col-xl-4';
    @endphp
    ...
    <div class="app-main__inner">
        ...
        <div class="tabs-animation">
            <div class="row">
                ...
                <div class="{{ $metricColClass }}">
                    <div class="card dashboard-card mb-4">
                        <div class="dashboard-card__body d-flex align-items-center justify-content-between">
                            <div>
                                <div class="dashboard-card__label">{{ trans('common.dashboard.checkin_summary') }}</div>
            ...
            <div class="row">
                <div class="{{ $isShoppingMenuActive ? 'col-xl-8' : 'col-xl-12' }}">
                    <div class="card dashboard-chart-card mb-4">
                        <div class="card-header border-0">
                            <div class="card-title">
                                {{ $isShoppingMenuActive ? trans('common.dashboard.booking_activity_title') : trans('common.dashboard.booking_daily_chart_title') }}
                            </div>
                            <div class="card-subtitle">
                                {{ trans('common.dashboard.range_label') }}: {{ $dateRangeLabel }}
                            </div>
                        </div>
