...
<div class="app-main__inner">
    ...
    <div class="card"><div class="card-header">Daftar Admin Hotel</div><div class="card-body table-responsive"><table id="adminTable" class="table table-striped table-bordered w-100"><thead><tr><th>Nama</th><th>Hotel</th><th>Username</th><th>Email</th><th>Total Login</th><th>Terakhir Login</th><th>Status</th><th>Aksi</th></tr></thead></table></div></div>
</div>
@endsection
@section('js')
<script>
$(function(){
 ...
 {data:'name',orderable:false,searchable:false},{data:'hotel_name',orderable:false,searchable:false},{data:'username',name:'username'},{data:'email',name:'email'},{data:'login_count',name:'login_count',defaultContent:0},{data:'last_login_at',name:'last_login_at',defaultContent:'-'},{data:'status_badge',orderable:false,searchable:false},{data:'action',orderable:false,searchable:false}
 ]});
