...
<div class="app-main__inner">
    ...
    <div class="card"><div class="card-header">Daftar Hotel</div><div class="card-body table-responsive">
        <table id="hotelTable" class="table table-striped table-bordered w-100"><thead><tr><th>Kode</th><th>Nama</th><th>Status</th><th>Lisensi</th><th>Tenant</th><th>Player</th><th>User</th><th>Storage Media</th><th>Aksi</th></tr></thead></table>
    </div></div>
</div>
@endsection
@section('js')
