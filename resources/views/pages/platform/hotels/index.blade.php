...
<div class="app-main__inner">
    ...
    <div class="card"><div class="card-header">Daftar Hotel</div><div class="card-body table-responsive">
        <table id="hotelTable" class="table table-striped table-bordered w-100"><thead><tr><th>Kode</th><th>Nama</th><th>Status</th><th>Jumlah User</th><th>Storage Media</th><th>Aksi</th></tr></thead></table>
    </div></div>
</div>
@endsection
@section('js')
...
{data:'code',name:'code'},{data:'name',name:'name'},{data:'status_badge',orderable:false,searchable:false},{data:'users_count',name:'users_count',searchable:false},{data:'configuration.media_root',defaultContent:'-',orderable:false,searchable:false},{data:'action',orderable:false,searchable:false}
]}); });
</script>
@endsection
