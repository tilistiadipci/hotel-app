                ...
                <div class="dropdown">
                    <button type="button" data-toggle="dropdown" class="p-0 btn btn-link">
                        <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                            ...
                            <span class="language-icon opacity-8 flag large {{ app()->getLocale() == 'id' ? 'ID' : 'GB' }}"></span>
                        </span>
                    </button>
                                    ...
                                    <div class="scroll-area-xs" style="height: 150px;">
                                        <div class="scrollbar-container ps">
                                            <ul class="nav flex-column">
                                                <li class="nav-item-header nav-item">{{ trans('common.my_account') }}</li>
                                                <li class="nav-item">
                                                    <a href="{{ route('profile.edit') }}"
                                                        class="nav-link"> {{ trans('common.profile.change') }}
                                                    </a>
                                                </li>
                                                <li class="nav-item">
