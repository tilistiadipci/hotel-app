...
class GuideCategoryController extends Controller
{
    ...
    private $page = 'guide-categories';
    private $icon = 'fa fa-folder';

    public function __construct(GuideCategoryRepository $categoryRepository, GuideItemRepository $itemRepository)
    {
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            'name' => [
                ...
                'string',
                'max:100',
                uniqueNotDeleted('guide_categories', 'name'),
            ],
    ...
    public function update(Request $request, string $uid)
    {
        ...
        $data = $request->validate([
            'name' => [
                ...
                'string',
                'max:100',
                uniqueNotDeleted('guide_categories', 'name', $category->id),
            ],
            'description' => 'nullable|string',
            'sort_order' => 'nullable|integer|min:0',
            'is_active' => 'nullable|boolean',
