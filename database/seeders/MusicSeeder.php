...
class MusicSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $continuum = Album::firstOrCreate(
            ...
            ['cover_image' => '/images/default/no-image.png', 'release_date' => '2006-09-12']
        );

        $sobRock = Album::firstOrCreate(
            ['artist_id' => $johnMayer->id, 'title' => 'Sob Rock'],
            ['cover_image' => '/images/default/no-image.png', 'release_date' => '2021-07-16']
        );

        $twentyOne = Album::firstOrCreate(
            ['artist_id' => $adele->id, 'title' => '21'],
            ['cover_image' => '/images/default/no-image.png', 'release_date' => '2011-01-24']
        );
